...
describe('<Private />', () => {
  ...
  it('should render Private Calendar', () => {
    let component;
    act(() => {
      component = mount(PrivateComponent);
      sleep(500);
    });
  ...
  */
  ...
  it('should handle click', () => {
    ...
    act(() => {
      ...
      component = mount(PrivateComponent, { attachTo: document.getElementById('including') });
      sleep(500);
      ...
      component.update();
      const close = wrapperPrivate.find('.closeButton');
